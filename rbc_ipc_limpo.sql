...
--
-- Máquina: localhost
-- Data de Criação: 04-Fev-2017 às 13:31
...
CREATE TABLE IF NOT EXISTS `descricaoproblema` (
  `id_descProblema` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `objetosaprendizagem` (
...
CREATE TABLE IF NOT EXISTS `objeto_estilo` (
  `id_objeto_estilo` int(11) NOT NULL AUTO_INCREMENT,
  `id_objeto` int(11) NOT NULL,
  `id_estilo` int(11) NOT NULL,
  PRIMARY KEY (`id_objeto_estilo`)
...
CREATE TABLE IF NOT EXISTS `pesquisas` (
  ...
  PRIMARY KEY (`id_log`),
  KEY `fk_idAluno_Log_idx` (`aluno_id`),
  KEY `fk_idSolucao_Log_idx` (`solucao_id`)
...
CREATE TABLE IF NOT EXISTS `solucaoproblema` (
  `id_solucaoProblema` int(11) NOT NULL AUTO_INCREMENT,
  `diagnostico` varchar(255) NOT NULL,
  `acaoPedagogica` varchar(1000) NOT NULL,
  `objetoAprendizagem` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_solucaoProblema`),
  KEY `fk_idObjeto_Solucao_idx` (`objetoAprendizagem`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=60 ;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  KEY `fk_idCurso_Usuario_idx` (`curso_id`),
  KEY `fk_idDisc_Usuario_idx` (`disciplina_id`)
...
(1, 'Aluno Teste', 'priscilla.batista18@hotmail.com', 3, 10, '02806338239', 22, 'Ativo', 'Aluno', '55ef6c7261d3b4f59258af40b8d61435', '', '', 1),
(2, 'Professor Teste', 'tammyhikari@gmail.com', 5, 10, '38236712345', 22, NULL, 'Professor', '55ef6c7261d3b4f59258af40b8d61435', '', '', NULL),
(3, 'TAMMY HIKARI', 'hikari_tammy@hotmail.com', NULL, 10, NULL, NULL, 'Verbal', 'Aluno', '55ef6c7261d3b4f59258af40b8d61435', NULL, NULL, 1);
