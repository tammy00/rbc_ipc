...
<div class="objetos-de-aprendizagem-form">
    ...
    <?= $form->field($model, 'estilo_objeto2')->dropDownList([$arrayDeEstilo],['prompt'=>'Selecione o segundo estilo'],['style'=>'width:530px']) ?>

    <?= $form->field($model, 'estilo_objeto3')->dropDownList([$arrayDeEstilo],['prompt'=>'Selecione o terceiro estilo'],['style'=>'width:530px']) ?>
